...
satellites = """
    SELECT DISTINCT satellite_id,
                       CASE hex(satellite_id)
                           ...
                           WHEN '04489F5245DED48D2A8AC8FB5F5CD1C6A638F7C6E75EFD800EF2D72000000000' THEN 'us2\t'
                       ...
                       CASE hex(satellite_id)
                           ...
                           WHEN 'F474535A19DB00DB4F8071A1BE6C2551F4DED6A6E38F0818C68C68D000000000' THEN 4
                           WHEN '84A74C2CD43C5BA76535E1F42F5DF7C287ED68D33522782F4AFABFDB40000000' THEN 5
